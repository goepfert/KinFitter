// //Classname: TFitParticlePInvThetaPhi
...
ClassImp(TFitParticlePInvThetaPhi)

//----------------
// Constructor --
//----------------
TFitParticlePInvThetaPhi::TFitParticlePInvThetaPhi()
  :TAbsFitParticle()
{ 
  init( 0, 0., 0);
}

TFitParticlePInvThetaPhi::TFitParticlePInvThetaPhi( const TFitParticlePInvThetaPhi& fitParticle )
...
TFitParticlePInvThetaPhi::TFitParticlePInvThetaPhi(TVector3* p, Double_t M, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()
{ 
  init(p, M, theCovMatrix);
}

TFitParticlePInvThetaPhi::TFitParticlePInvThetaPhi(const TString &name, const TString &title,
...
TAbsFitParticle* TFitParticlePInvThetaPhi::clone( TString newname ) const {
  // Returns a copy of itself
  
  TAbsFitParticle* myclone = new TFitParticlePInvThetaPhi( *this );
...
// Operations --
//--------------
void TFitParticlePInvThetaPhi::init(TVector3* p, Double_t M, const TMatrixD* theCovMatrix) {
...
TLorentzVector* TFitParticlePInvThetaPhi::calc4Vec( const TMatrixD* params ) {
...
void TFitParticlePInvThetaPhi::setIni4Vec(const TLorentzVector* pini) {
...
void TFitParticlePInvThetaPhi::setIni4Vec(const TVector3* p, Double_t M) {
  // Set the initial 4vector. Will also set the 
  // inital parameter values 
...
TMatrixD* TFitParticlePInvThetaPhi::getDerivative() {
...
TMatrixD* TFitParticlePInvThetaPhi::transform(const TLorentzVector& vec) {
