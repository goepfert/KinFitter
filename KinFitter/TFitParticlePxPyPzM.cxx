...
// [four free parameters (px, py, pz, d) with initial values (px, py, pz, m)]
//
// p = px*u1 + py*u2 + pz*u3
// E = Sqrt( |p|^2 + d^2 )
//
...
ClassImp(TFitParticlePxPyPzM)

//----------------
// Constructor --
//----------------
TFitParticlePxPyPzM::TFitParticlePxPyPzM()
  :TAbsFitParticle()  
{
  init(0, 0);
}

TFitParticlePxPyPzM::TFitParticlePxPyPzM( const TFitParticlePxPyPzM& fitParticle )
...
TFitParticlePxPyPzM::TFitParticlePxPyPzM(TLorentzVector* pini, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()  
{
  init(pini, theCovMatrix);
}

TFitParticlePxPyPzM::TFitParticlePxPyPzM(const TString &name, const TString &title, 
...
TAbsFitParticle* TFitParticlePxPyPzM::clone( TString newname ) const {
  // Returns a copy of itself

  TAbsFitParticle* myclone = new TFitParticlePxPyPzM( *this );
...
// Operations --
//--------------
void TFitParticlePxPyPzM::init(TLorentzVector* pini, const TMatrixD* theCovMatrix ) {
...
TLorentzVector* TFitParticlePxPyPzM::calc4Vec( const TMatrixD* params ) {
  ...
  Double_t E =  TMath::Sqrt( X*X + Y*Y + Z*Z + (*params)(3,0)*(*params)(3,0) );
...
void TFitParticlePxPyPzM::setIni4Vec(const TLorentzVector* pini) {
...
TMatrixD* TFitParticlePxPyPzM::getDerivative() {
  ...
  (*DerivativeMatrix)(3,3) = _parameters(3,0)/_pcurr.E();

  return DerivativeMatrix;  
}

TMatrixD* TFitParticlePxPyPzM::transform(const TLorentzVector& vec) {
