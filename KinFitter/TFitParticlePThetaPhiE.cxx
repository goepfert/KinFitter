// //Classname: TFitParticlePThetaPhiE
...
ClassImp(TFitParticlePThetaPhiE)

//----------------
// Constructor --
//----------------
TFitParticlePThetaPhiE::TFitParticlePThetaPhiE()
  :TAbsFitParticle()  
{
  init(0, 0);
}

TFitParticlePThetaPhiE::TFitParticlePThetaPhiE( const TFitParticlePThetaPhiE& fitParticle )
...
TFitParticlePThetaPhiE::TFitParticlePThetaPhiE(TLorentzVector* pini, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()  
{
  init(pini, theCovMatrix);
}

TFitParticlePThetaPhiE::TFitParticlePThetaPhiE(const TString &name, const TString &title, 
...
TAbsFitParticle* TFitParticlePThetaPhiE::clone( TString newname ) const {
  // Returns a copy of itself
  
  TAbsFitParticle* myclone = new TFitParticlePThetaPhiE( *this );
...
// Operations --
//--------------
void TFitParticlePThetaPhiE::init(TLorentzVector* pini, const TMatrixD* theCovMatrix ) {
...
TLorentzVector* TFitParticlePThetaPhiE::calc4Vec( const TMatrixD* params ) {
...
void TFitParticlePThetaPhiE::setIni4Vec(const TLorentzVector* pini) {
...
TMatrixD* TFitParticlePThetaPhiE::getDerivative() {
...
TMatrixD* TFitParticlePThetaPhiE::transform(const TLorentzVector& vec) {
