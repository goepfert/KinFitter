// //Classname: TFitParticlePThetaPhi
...
ClassImp(TFitParticlePThetaPhi)

//----------------
// Constructor --
//----------------
TFitParticlePThetaPhi::TFitParticlePThetaPhi()
  :TAbsFitParticle()
{ 
  init( 0, 0., 0);
}

TFitParticlePThetaPhi::TFitParticlePThetaPhi( const TFitParticlePThetaPhi& fitParticle )
...
TFitParticlePThetaPhi::TFitParticlePThetaPhi(TVector3* p, Double_t M, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()
{ 
  init(p, M, theCovMatrix);
}

TFitParticlePThetaPhi::TFitParticlePThetaPhi(const TString &name, const TString &title,
...
TAbsFitParticle* TFitParticlePThetaPhi::clone( TString newname ) const {
  // Returns a copy of itself
  
  TAbsFitParticle* myclone = new TFitParticlePThetaPhi( *this );
...
// Operations --
//--------------
void TFitParticlePThetaPhi::init(TVector3* p, Double_t M, const TMatrixD* theCovMatrix) {
...
TLorentzVector* TFitParticlePThetaPhi::calc4Vec( const TMatrixD* params ) {
...
void TFitParticlePThetaPhi::setIni4Vec(const TLorentzVector* pini) {
...
void TFitParticlePThetaPhi::setIni4Vec(const TVector3* p, Double_t M) {
  // Set the initial 4vector. Will also set the 
  // inital parameter values 
...
TMatrixD* TFitParticlePThetaPhi::getDerivative() {
...
TMatrixD* TFitParticlePThetaPhi::transform(const TLorentzVector& vec) {
