...
// [four free parameters (px, py, pz, E) with initial values (px, py, pz, E)]
//
// p(fit) = px*u1 + py*u2 + pz*u3
// E(fit) = E
//
...
ClassImp(TFitParticlePxPyPzE)

//----------------
// Constructor --
//----------------
TFitParticlePxPyPzE::TFitParticlePxPyPzE()
  :TAbsFitParticle()  
{
  init(0, 0);
}

TFitParticlePxPyPzE::TFitParticlePxPyPzE( const TFitParticlePxPyPzE& fitParticle )
...
TFitParticlePxPyPzE::TFitParticlePxPyPzE(TLorentzVector* pini, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()  
{
  init(pini, theCovMatrix);
}

TFitParticlePxPyPzE::TFitParticlePxPyPzE(const TString &name, const TString &title, 
...
TAbsFitParticle* TFitParticlePxPyPzE::clone( TString newname ) const {
  // Returns a copy of itself

  TAbsFitParticle* myclone = new TFitParticlePxPyPzE( *this );
...
// Operations --
//--------------
void TFitParticlePxPyPzE::init(TLorentzVector* pini, const TMatrixD* theCovMatrix ) {
...
TLorentzVector* TFitParticlePxPyPzE::calc4Vec( const TMatrixD* params ) {
...
void TFitParticlePxPyPzE::setIni4Vec(const TLorentzVector* pini) {
...
TMatrixD* TFitParticlePxPyPzE::getDerivative() {
  // returns derivative dP/dy with P=(p,E) and y=(px, py, pz, E) 
...
TMatrixD* TFitParticlePxPyPzE::transform(const TLorentzVector& vec) {
