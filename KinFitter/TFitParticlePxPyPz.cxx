...
// [three free parameters (px, py, pz) with initial values (px, py, pz)]
//
// p = px*u1 + py*u2 + pz*u3
// E = Sqrt( |p|^2 + m^2 )
//
...
ClassImp(TFitParticlePxPyPz)

//----------------
// Constructor --
//----------------
TFitParticlePxPyPz::TFitParticlePxPyPz()
  :TAbsFitParticle()
{ 
  init( 0, 0., 0);
}

TFitParticlePxPyPz::TFitParticlePxPyPz( const TFitParticlePxPyPz& fitParticle )
...
TFitParticlePxPyPz::TFitParticlePxPyPz(TVector3* p, Double_t M, const TMatrixD* theCovMatrix)
  :TAbsFitParticle()
{ 
  init(p, M, theCovMatrix);
}

TFitParticlePxPyPz::TFitParticlePxPyPz(const TString &name, const TString &title,
...
TAbsFitParticle* TFitParticlePxPyPz::clone( TString newname ) const {
  // Returns a copy of itself

  TAbsFitParticle* myclone = new TFitParticlePxPyPz( *this );
...
// Operations --
//--------------
void TFitParticlePxPyPz::init(TVector3* p, Double_t M, const TMatrixD* theCovMatrix) {
...
TLorentzVector* TFitParticlePxPyPz::calc4Vec( const TMatrixD* params ) {
...
void TFitParticlePxPyPz::setIni4Vec(const TLorentzVector* pini) {
...
void TFitParticlePxPyPz::setIni4Vec(const TVector3* p, Double_t M) {
  // Set the initial 4vector. Will also set the 
  // inital parameter values
...
TMatrixD* TFitParticlePxPyPz::getDerivative() {
...
TMatrixD* TFitParticlePxPyPz::transform(const TLorentzVector& vec) {
